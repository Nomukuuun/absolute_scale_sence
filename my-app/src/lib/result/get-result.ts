...
const SCORE_RANKS = [
  { min: 100, label: "ガバガバ...",              message: "回答と実際のスケールが大きく乖離しています。\n何回かチャレンジして感覚を磨いていきましょう！" },
  { min:  51, label: "ちょいガバ",               message: "まずまずの感覚ですが、実際のスケールとは結構乖離があるようです。\n身の回りのモノをよく観察してみるといいかもしれません！" },
  { min:  26, label: "凡人",                     message: "人並みのスケール感覚をお持ちです。\n身の回りのモノのスケールを意識しながら生活していきましょう！" },
  { min:  15, label: "天才的",                   message: "素晴らしいスケール感覚を持っています。\n友人から大体のスケールを聞かれたら得意気に答えてあげましょう！\n（そのような機会があればですが...）" },
